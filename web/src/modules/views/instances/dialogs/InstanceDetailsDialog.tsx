...
import { Loader2, Save, Upload, Image as ImageIcon, Settings2, Ban, Trash2 } from 'lucide-react'
...
export function InstanceDetailsDialog({ instanceId, isOpen, onClose, onSuccess, onDelete }: InstanceDetailsDialogProps) {
            ...
            <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
                ...
                <DialogFooter className="flex justify-between sm:justify-between">
                    <Button variant="destructive" size="sm" onClick={() => {
                        if (confirm("¿Estás seguro de eliminar esta instancia? Esta acción no se puede deshacer.")) {
                            api.instances.delete(instanceId!).then(() => {
                                onSuccess()
                                onDelete?.()
                                onClose()
                            })
